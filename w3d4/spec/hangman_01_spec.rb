  ...
  describe "Hangman" do
    ...
    describe "#initialize" do
      ...
      it "doesn't perform any setup" do
        ...
        expect(game.referee).not_to receive(:register_secret_length)
        game
      end
    end
    ...
    describe "#setup" do
      ...
      it "tells the referee the length of the secret word" do
        expect(game.referee).to receive(:register_secret_length).with(length)
    ...
    describe "#take_turn" do
      ...
      it "has the referee respond to input" do
        expect(game.referee).to receive(:handle_response)
      end
    end
  end
end
